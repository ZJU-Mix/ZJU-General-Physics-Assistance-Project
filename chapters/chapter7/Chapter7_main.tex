...
\chapter[热力学]{\itr{Thermodynamics}{热力学}}
    ...
    \section[理想气体]{\itr{Ideal Gas}{理想气体}}
        ...
        这是一个实验结论，理论上也可以证明(可见\refleaf{prove7.11})
    \section[分子动理论]{\itr{Kinetic Theory of Molecules}{分子动理论}}
        \subsection[压强的微观解释]{\itr{the Microscopic View of Pressure}{压强的微观解释}}
            ...
            可以得到压强与分子数密度以及速率的关系如下(证明见\refleaf{prove7.1})：
            \begin{equation}
        ...
        \subsection[能量均分原理]{\itr{Equipartition Theorem}{能量均分原理}}
            ...
            \end{Itemize}
            \ \newline 
            有了自由度的概念，根据大量的实验事实总结有如下关系成立(理论上也可以证明,可见\refleaf{prove7.11})：
            \begin{equation}
                U = \frac{i}{2}Nk_{B}T
                \nonumber
            \end{equation}
        ...
        \subsection[麦克斯韦分布]{\itr{Maxwell Distribution}{麦克斯韦分布}}
            ...
            \itr{Maxwell Distribution}{麦克斯韦分布}给出了理想气体的速率分布规律，它给出的速率分布函数如下(证明可见\refleaf{prove7.10})：
            \begin{equation}
        ...
        \subsection[玻尔兹曼分布]{\itr{Boltzmann Distribution}{玻尔兹曼分布}}
            ...
            \begin{equation}
                ...
                \nonumber
            \end{equation}
            这一分布称为\itr{Boltzmann Distribution}{玻尔兹曼分布}(严谨证明见\refleaf{prove7.9})，
        ...
        \subsection[平均自由程]{\itr{Mean Free Path}{平均自由程}}
            ...
            如将分子视为直径为$d$的球体且分子做平均速度为$v$的折线运动，可以得到平均碰撞次数$\upperline{Z}$为(证明见\refleaf{prove7.2})：
            \begin{equation}
    ...
    \section[热力学第一定律]{\itr{First Law of Thermodynamics}{热力学第一定律}}
        \subsection[热与功]{\itr{Heat and Work}{热与功}}
            ...
            \begin{equation}
                ...
                \nonumber
            \end{equation}
        \subsection[过程介绍]{\itr{Process Introduction}{过程介绍}}
        为方便查阅把熵的计算也写在此处
        \begin{Itemize}
    ...
    \section[热力学第二定律]{\itr{Second Law of Thermodynamics}{热力学第二定律}}
        \subsection[热机]{\itr{Heat Engine}{热机}}
            ...
            \end{singlefigure}
            使用奥托循环的热机效率为(证明见\refleaf{prove7.7})：
            \begin{equation}
            ...
            \end{singlefigure}
            使用正卡诺循环的热机称为\itr{Carnot Heat Engine}{卡诺热机}，其热机效率为(证明见\refleaf{prove7.8})：
            \begin{equation}
                e = 1 - \frac{T_{c}}{T_{h}}
                \nonumber
            \end{equation}
        ...
        \subsection[熵]{\itr{Entropy}{熵}}
            ...
            由于等温，$\Delta U=0$；那么由热力学第一定律，自然有$Q=0$。但是计算它的熵变，这个值为$\Delta S = nR\ln\dfrac{V_2}{V_1}>0$(见\refleaf{example7.6}(b))。
