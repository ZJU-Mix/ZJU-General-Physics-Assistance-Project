...
\end{singlefigure}
\end{example}
\begin{example}[Perfectly Inelastic Collison of two Relastivistic Particles---\refleafmark{solution6.6}]
    ...
    \end{singlefigure}
\end{example}
\begin{example}[Relastivistic Scattering between a Photon and an Electron---\refleafmark{solution6.7}]
